...
app.get("/", async (req, res) => {
  const { data, error } = await resend.emails.send({
    from: 'Livo <noreaply@ifaststore.it>',
            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td align="center">
                  <table cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td valign="bottom" align="center">
                        <table cellpadding="0" cellspacing="0" role="none">
                          <tr>
                            <td style="height: 80px; width: 80px; border-radius: 26px; background-color: #e5e5e5">
                              <img src="https://img-64e62d326ae56091b6bce833a76dafa6b1758ff9.s3.amazonaws.com/logos/atgb.png" alt="Livo Logo" style="width: 100%; object-fit: cover">
                            </td>
                          </tr>
                        </table>
                  ...
                  <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td align="{{ align }}" class="bg-var--card border-solid_1px_var--border text-var--text" style="border-radius: 25px; background-color: #191919; padding: 24px; color: #fff; border: 1px solid #2c2c2c"> <span data-subtitle style="font-weight: 600; letter-spacing: -1px; font-size: clamp(10px, 8vw, 18px)"> <p style="margin: 0; text-align: center">Informamos que seu visitante</p>
                    <p style="margin: 0; text-align: center">
                      <span style="text-align: center; color: #663c9d">Pablo Novaes
                        ...
                        <div class="sm-w-60pc sm-pb-px" style="margin-left: auto; margin-right: auto; max-height: 280px; max-width: 280px; overflow: hidden; border-radius: 24px; padding: 4px; border: 3px solid #4f2b78">
              ...
              <tr>
                <td>
                  <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td align="{{ align }}" class="bg-var--card border-solid_1px_var--border text-var--text" style="border-radius: 25px; background-color: #191919; padding: 24px; color: #fff; border: 1px solid #2c2c2c">
                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                          ...
                          <tr align="center" data-content class="resize-text" style="line-height: 22px; text-align: center; font-weight: 300; font-size: clamp(10px, 8vw, 12px)">
                            <td>
                              <a target="_blank" class="resize-text text-var--primary" href="https://api.whatsapp.com/send?phone=5511991534123&text=Ol%C3%A1%2C%20gostaria%20de%20ajuda%20com%20a%20plataforma%20Livo." style="color: #663C9D">
                ...
                <td>
                  <div class="text-var--text" style="border-radius: 25px; padding: 24px; color: #fff">
                    <table align="center" style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                      ...
                      <tr align="center" style="font-size: 13px; font-weight: 400; color: currentColor">
